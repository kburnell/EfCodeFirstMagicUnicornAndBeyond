...
namespace Demo1.DataContext {
    ...
    public class DataContextInitializer : DropCreateDatabaseIfModelChanges<Demo1DataContext>
    {
        ...
        private void SeedManufacturer(Demo1DataContext context)
        {
            ...
            _ferrari.Location = DbGeography.FromText("POINT(44.53244  10.86412)");
            _lamborghini.Location = DbGeography.FromText("POINT (44.65934 11.12693)");
            _astonMartin.Location = DbGeography.FromText("POINT (52.18708 -1.48351)");
            _porsche.Location = DbGeography.FromText("POINT (48.83498 9.15231)");
