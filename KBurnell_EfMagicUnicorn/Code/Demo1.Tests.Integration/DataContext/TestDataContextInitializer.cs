...
namespace Demo1.Tests.Integration.DataContext
{
    public class TestDataContextInitializer : DropCreateDatabaseIfModelChanges<Demo1DataContext>
    {
        ...
        protected override void Seed(Demo1DataContext context)
        {
        ...
        private void SeedManufacturer(Demo1DataContext context)
        {
        ...
        private void SeedEngine(Demo1DataContext context)
        {
        ...
        private void SeedModel(Demo1DataContext context)
        {
            _ferrari458Italia = new Model { Name = "458 Italia", BasePrice = 220000, Year = 2012, Manufacturer = _ferrari, AvailableEngines = new List<Engine> { _ferrariV8, _ferrariV12 }};
            _ferrariScaglietti = new Model { Name = "Scaglietti", BasePrice = 313000, Year = 2012, Manufacturer = _ferrari, AvailableEngines = new List<Engine> { _ferrariV12 }};
            _lamborghiniGallardo = new Model { Name = "Gallardo LP 570-4 Superleggera", BasePrice = 237600, Year = 2012, Manufacturer = _lamborghini, AvailableEngines = new List<Engine> { _lamborghiniV10 }};
            _lamborghiniAventador = new Model { Name = "Aventador LP 700-4", BasePrice = 387000, Year = 2012, Manufacturer = _lamborghini, AvailableEngines = new List<Engine> { _lamborghiniV12 }};
            _astonMartinDB9 = new Model { Name = "DB9", BasePrice = 185000, Year = 2012, Manufacturer = _astonMartin, AvailableEngines = new List<Engine> { _astonMartinV12 }};
            _astonMartinV12Vantage = new Model { Name = "V12 Vantage", BasePrice = 180000, Year = 2012, Manufacturer = _astonMartin, AvailableEngines = new List<Engine> { _astonMartinV12 }};
            _porsche911GT2R2 = new Model { Name = "911 GT2 R2", BasePrice = 245000, Year = 2012, Manufacturer = _porsche, AvailableEngines = new List<Engine> { _porscheStraight6 }};
